...
if __name__ == "__main__":
    # 修改为你自己的输入 CSV 文件路径
    input_file = r"E:\何磊\子刊讨论\Mannequin Test Dataset\06-10-2013-NoVideo\Original Recorded Data\Data\30_static.csv"
    
    # 修改为你想要保存的输出文件夹路径
    output_dir = r"E:\何磊\子刊讨论\Mannequin Test Dataset\06-10-2013-NoVideo\Original Recorded Data\Data\30_static"
